	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form>
	          	<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* POST ID</h5>
					</div>
					<div class="col-lg-6">
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* TITLE</h5>
					</div>
					<div class="col-lg-6">
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* TAGS</h5>
					</div>
					<div class="col-lg-6">
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* FUN_START_DT</h5>
					</div>
					<div class="col-lg-6">
						<!-- <input type="text" id="EMAIL" name ="EMAIL" readonly> -->
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* FUN_END_DT</h5>
					</div>
					<div class="col-lg-6">
						<!-- <input type="text" id="EMAIL" name ="EMAIL" readonly> -->
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* TGT_AMT</h5>
					</div>
					<div class="col-lg-6">
						<!-- <input type="text" id="EMAIL" name ="EMAIL" readonly> -->
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* OPEN_AMT</h5>
					</div>
					<div class="col-lg-6">
						<!-- <input type="text" id="EMAIL" name ="EMAIL" readonly> -->
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* TYPE</h5>
					</div>
					<div class="col-lg-6">
						<!-- <input type="text" id="EMAIL" name ="EMAIL" readonly> -->
				...
				<div class="row mb-1 " >
					<div class="col-lg-6">
						<h5 class="mb-0 edit-title">* MEMBER_ID</h5>
					</div>
					<div class="col-lg-6">
						<!-- <input type="text" id="EMAIL" name ="EMAIL" readonly> -->
				...
				<div class="row mb-1 " >
					<div class="col-lg-6 ">
						<h5 class="mb-0 edit-title">* AI_YN</h5>
					</div>
